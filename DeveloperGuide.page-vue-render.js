...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ul',[_c('li',[_v("Download the jar file and copy it into an empty folder.")]),_v(" "),_c('li',[_v("Double-click the jar file."),_c('br'),_v(" "),_c('strong',[_v("Expected:")]),_v(" Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ul',[_c('li',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")]),_v(" "),_c('li',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v(" "),_c('strong',[_v("Expected:")]),_v(" The most recent window size and location are retained.")])])])])}
},function anonymous(
) {
