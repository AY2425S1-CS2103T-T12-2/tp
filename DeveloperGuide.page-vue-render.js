...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ul',[_c('li',[_v("Download the jar file and copy it into an empty folder.")]),_v(" "),_c('li',[_v("Double-click the jar file."),_c('br'),_v(" "),_c('strong',[_v("Expected:")]),_v(" Shows the GUI with a set of sample contacts. The window size may not be optimum."),_c('br')])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ul',[_c('li',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")]),_v(" "),_c('li',[_v("Re-launch the app by double-clicking the jar file."),_c('br'),_v(" "),_c('strong',[_v("Expected:")]),_v(" The most recent window size and location are retained.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Handling invalid commands")]),_v(" "),_c('ul',[_c('li',[_v("Test case: Enter invalid commands, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete abc")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/")]),_v(" (missing parameters)."),_c('br'),_v(" "),_c('strong',[_v("Expected:")]),_v(" Clear error message appears, with no unintended changes to the data."),_c('br')])])]),_v(" "),_c('li',[_c('p',[_v("Testing data persistence")]),_v(" "),_c('ul',[_c('li',[_v("After making several changes, close and reopen the application."),_c('br'),_v(" "),_c('strong',[_v("Expected:")]),_v(" All recent changes persist, confirming successful data saving."),_c('br')])])]),_v(" "),_c('li',[_c('p',[_v("Dealing with missing/corrupted data files")]),_v(" "),_c('ul',[_c('li',[_v("To simulate a missing data file, go into the folder where your jar file is stored, and delete the folder named 'data'.")]),_v(" "),_c('li',[_v("To simulate a corrupted data file, go into the folder where you jar file is stored, click into the data folder, and edit the addressbook.json in a way that it contains syntax error(s). "),_c('br'),_v(" "),_c('strong',[_v("Expected:")]),_v(" The application will start with an empty contact list there is no data available or if the data has been corrupted.")])])])])}
},function anonymous(
) {
