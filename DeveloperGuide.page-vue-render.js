...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("PlanPerfect App")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Wedding Planner")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Contact Details")]),_v(": Info about a contact: name, email, address, phone number etc.")]),_v(" "),_c('li',[_c('strong',[_v("Contact/Person")]),_v(": Used Interchangeably. Contact is used for contextual descriptions in the User/Developer Guides. A contact is modelled as a Person class in code.")]),_v(" "),_c('li',[_c('strong',[_v("CLI")]),_v(": Command Line Interface")]),_v(" "),_c('li',[_c('strong',[_v("GUI")]),_v(": Graphic User Interface")])])}
},function anonymous(
) {
