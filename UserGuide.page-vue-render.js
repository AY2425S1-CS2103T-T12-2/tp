...
with(this){return _c('ul',[_c('li',[_v("Untags the contact at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(". The index refers to the index number shown next to a contact's name in the displayed contact list. The index "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, ...")]),_v(" "),_c('li',[_v("If the user only wants to remove specific tags from the contact, at least one tag to remove must be specified.")]),_v(" "),_c('li',[_v("The user can remove multiple tags from a contact by separating them with a space.")]),_v(" "),_c('li',[_v("The user can alternatively remove all tags associated with a contact by using 'untag INDEX t/all'.")])])}
},function anonymous(
) {
